...
const projectsData = [
  ...
  },
  {
    ...
    description: 'A react application built for chatting. Login with Google or Facebook & enjoy chatting with many features.',
...
codeLink: 'https://github.com/ankitb2023/Chat-app'
  ...
  {
    title: 'Weather App',
    description: 'Check the weather status of a city by entering its name or pincode.',
...
codeLink: 'https://github.com/ankitb2023/Weather-App'
  },
  {
    ...
    description: 'A Classic game created with React.js featuring history of moves and an animated winner display.',
...
codeLink: 'https://github.com/ankitb2023/tictacgame'
  ...
  {
    title: 'Box-office',
    description: 'Shows details about movies and web series, including predictions for upcoming seasons.',
...
codeLink: 'https://github.com/ankitb2023/box-office-lighttheme'
  },
  {
    ...
    description: 'An Ecommerce web app featuring shopping cart and product filter functionality.',
          ...
          <div className="box tilt" key={index}>
            ...
            <div className="content">
              ...
              <div className="desc">
                ...
                <div className="btns">
                  <a href={project.viewLink} className="btn" target="_blank" rel="noopener noreferrer">
